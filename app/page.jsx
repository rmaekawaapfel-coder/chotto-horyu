  ...
  return (
    <div className={`inline-flex min-h-[72px] items-center gap-3 rounded-2xl border px-5 py-3 text-base font-semibold ${styles}`}>
      ...
      <span className="text-base">
        {level === "高" ? "危機一髪" : level === "中" ? "危険水域" : score === 0 ? "未入力" : "安心水準"}
      </span>
    </div>
  );
}
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-white text-neutral-950">
      <div className="mx-auto max-w-6xl px-6 py-8 md:px-10 md:py-12">
                ...
                <div className="mt-4 rounded-[34px] bg-white text-neutral-950">
                  ...
                  <div className="space-y-4 p-6">
                    ...
                    <div className="rounded-[24px] bg-rose-50 p-5">
                      ...
                      <div className="mt-3 rounded-[20px] bg-white px-4 py-5 text-[15px] font-semibold text-rose-700 shadow-[0_1px_0_rgba(0,0,0,0.03)]">
                        危険度は 82点（高）危機一髪
                      </div>
        ...
        <section className="mt-10 rounded-[28px] bg-white/40 p-6 md:p-8">
          ...
          <h3 className="mt-2 text-2xl font-semibold tracking-[-0.03em]">送る前に、一回だけ整える</h3>
                ...
                <div className="space-y-5 p-6">
                  <div className="rounded-[26px] bg-neutral-50 p-6">
                    ...
                    <div className="mt-5 space-y-3 text-sm text-neutral-700">
                      ...
                      <div className="rounded-[20px] bg-white px-4 py-4 leading-7 shadow-[0_1px_0_rgba(0,0,0,0.03)]">
                        なんで返信くれないの？こっちはずっと気にしてたんだけど。もういいわ。
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="rounded-[26px] bg-rose-50 p-6">
                    ...
                    <div className="mt-5 rounded-[20px] bg-white px-4 py-5 text-[15px] font-semibold text-rose-700 shadow-[0_1px_0_rgba(0,0,0,0.03)]">
                      危険度は 82点（高）危機一髪
                    </div>
                    <div className="mt-4 text-sm leading-7 text-rose-950/90">
                      いまの文面は本音より勢いが前に出ています。今は送らず、ちょっと保留がおすすめです。
                    </div>
                  </div>
                  ...
                  <div className="rounded-[26px] bg-blue-50/70 p-6">
                    ...
                    <div className="mt-4 rounded-full bg-neutral-950 px-4 py-3 text-center text-sm font-medium text-white">
                      文面をコピーする
                    </div>
                  </div>
                </div>
        ...
        <section id="checker" className="mt-10 rounded-[32px] bg-white/40 p-6 md:p-8">
          ...
          <h2 className="mt-2 text-2xl font-semibold tracking-[-0.03em] md:text-[2.2rem]">送る前にチェックする</h2>
          ...
          <div className="mt-8 grid gap-4 md:grid-cols-[190px_1fr]">
            <div>
              ...
              <OptionChips options={["恋人", "上司", "友達", "グループ"]} value={recipient} onChange={setRecipient} />
              <input
                value={recipient}
                onChange={(e) => setRecipient(e.target.value)}
                placeholder="例: 恋人 / 上司 / 友達"
                className="mt-3 w-full rounded-2xl bg-white/70 px-4 py-3 text-sm text-neutral-900 placeholder:text-neutral-400 outline-none"
              />
            </div>
            <div>
              ...
              <textarea
                ...
                className="min-h-[240px] w-full rounded-[24px] bg-white/70 px-5 py-4 text-sm leading-6 text-neutral-900 placeholder:text-neutral-400 outline-none"
              />
            </div>
          </div>
            ...
            <div ref={resultRef} className="mt-6 rounded-[28px] bg-white/70 p-5 md:p-6">
              ...
              {showRewrite ? (
                <div className={result.level === "高" ? "mt-4 rounded-2xl bg-rose-50/85 p-5" : "mt-4 rounded-2xl bg-white/40 p-5"}>
                  <div className={result.level === "高" ? "text-[11px] tracking-[0.22em] text-rose-700 uppercase" : "text-[11px] tracking-[0.22em] text-neutral-400 uppercase"}>
                    推奨文章
                  </div>
                  <div
                    className={
                      result.level === "高"
                        ? "mt-3 rounded-2xl border border-rose-100 bg-white p-4 text-sm leading-7 text-rose-950"
                        : "mt-3 rounded-2xl bg-white/70 p-4 text-sm leading-7 text-neutral-900"
                    }
                  >
                    {result.rewrite}
                  </div>
              ...
              <div className="mt-4 rounded-2xl bg-white/70 p-5">
                ...
                <div className="mt-3 flex flex-wrap gap-2">
                  {["かなりしっくりきた", "まあまあ", "微妙", "ぜんぜん違う"].map((item) => (
                    <button
                      key={item}
                      type="button"
                ...
                {showRewrite && (
                  <>
                    ...
                    <div className="mt-3 flex flex-wrap gap-2">
                      {["そのまま使える", "少し直せば使える", "使いづらい"].map((item) => (
                        <button
                          key={item}
                          type="button"
                ...
                <div className="mt-3 flex flex-wrap gap-2">
                  {["そのまま送った", "言い換えて送った", "送らなかった", "ちょっと保留にした"].map((item) => (
                    <button
                      key={item}
                      type="button"
        ...
        <section className="mt-10 space-y-6">
          <div className="rounded-[28px] bg-white/70 p-6 md:p-8">
            ...
            <h3 className="mt-2 text-2xl font-semibold tracking-[-0.03em]">こんな時のために</h3>
          ...
          <div className="rounded-[28px] bg-neutral-950 p-6 text-white md:p-8">
            ...
            <h3 className="mt-2 text-2xl font-semibold tracking-[-0.03em]">このページをシェアする</h3>
            ...
            <p className="mt-4 text-xs leading-5 text-white/45">公開後は、ページURLをXやLINE、メモなどに貼って使えます。</p>
          </div>
        </section>
      </div>
    </div>
